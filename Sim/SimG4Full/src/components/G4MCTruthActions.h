#ifndef SIMG4FULL_G4MCTRUTHACTIONS_H
#define SIMG4FULL_G4MCTRUTHACTIONS_H
...
class G4MCTruthActions: public AlgTool, virtual public IG4ActionTool {
public:
   explicit G4MCTruthActions(const std::string& type , const std::string& name,
               const IInterface* parent);
   virtual ~G4MCTruthActions();
...
#endif /* SIMG4FULL_G4MCTRUTHACTIONS_H */
