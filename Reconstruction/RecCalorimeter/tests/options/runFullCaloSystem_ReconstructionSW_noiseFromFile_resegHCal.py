...
barrelHcalGeometry = LayerPhiEtaCaloTool("HcalBarrelGeo",
                                         ...
                                         activeVolumesRadii = [1.2524, 1.2234, 1.1956, 1.15609, 1.1189, 1.08397, 1.0509, 0.9999, 0.9534, 0.91072])
...
barrelHcalExtGeometry = LayerPhiEtaCaloTool("HcalExtBarrelGeo",
                                         readoutName = hcalBarrelReadoutName,
                                         activeVolumeName = "layerVolume",
                                         activeFieldName = "layer",
                                         fieldNames = ["system"],
                                         fieldValues = [8],
                                         activeVolumesNumber = 8,
                                         activeVolumesRadii = [1.2524, 1.2234, 1.1956, 1.15609, 1.1189, 1.08397, 1.0509, 0.9999])
createHcalExtBarrelCells = CreateCaloCells("CreateHCalExtBarrelCells",
                                        geometryTool = barrelHcalExtGeometry,
                                        doCellCalibration=False, # already calibrated                                                                                                                                                       
                                        addCellNoise=True, filterCellNoise=False,
                                        noiseTool = noiseHcal,
                                        hits = hcalExtBarrelCellsName,
                                        cells = hcalExtBarrelCellsName+"Noise",
                                        OutputLevel=DEBUG)
