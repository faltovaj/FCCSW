...
saveexthcaltool = SimG4SaveCalHits("saveExtHCalHits",readoutNames = [hcalExtBarrelReadoutName])
...
# Hcal barrel cell positions                                                                                                                                                                                                              
from Configurables import CreateVolumeCaloPositions
positionsHcalExtBarrel = CreateVolumeCaloPositions("positionsExtBarrelHcal", OutputLevel = INFO)
positionsHcalExtBarrel.hits.Path = "HCalExtBarrelCellsStep1"
positionsHcalExtBarrel.positionedHits.Path = "HCalExtBarrelPositions"
# Use Phi-Eta segmentation in Hcal barrel                                                                                                                                                                                                  
from Configurables import RedoSegmentation
