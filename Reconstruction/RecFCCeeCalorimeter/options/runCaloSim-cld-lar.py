...
path_to_detector = ''
detectors_to_use=[
                    'Detector/DetFCCeeCLD-LAr/compact/FCCee_DectMaster.xml',
                  ]
...
# HCAL
hcalBarrelReadoutName = "HCalBarrelCollection"
...
savehcalbarreltool = SimG4SaveCalHits("saveHCalBarrelHits", readoutNames = [hcalBarrelReadoutName])
savehcalbarreltool.positionedCaloHits.Path = "HCalBarrelPositionedHits"
savehcalbarreltool.caloHits.Path = "HCalBarrelHits"
...
#JF: TODO - sampling fraction for CLD HCAL?!!!!
from Configurables import CalibrateCaloHitsTool
calibHcells = CalibrateCaloHitsTool("CalibrateHCal", invSamplingFraction="1.0")
