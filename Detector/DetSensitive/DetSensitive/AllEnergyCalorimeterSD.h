#ifndef DETSENSITIVE_ALLENERGYCALORIMETERSD_H
#define DETSENSITIVE_ALLENERGYCALORIMETERSD_H
...
/** AllEnergyCalorimeterSD DetectorDescription/DetSensitive/src/AllEnergyCalorimeterSD.h AllEnergyCalorimeterSD.h
 *
 *  Sensitive detector for calorimeter which collects all energy - including invisible.
...
namespace det {
class AllEnergyCalorimeterSD : public G4VSensitiveDetector {
public:
  /** Constructor.
   ...
   */
  AllEnergyCalorimeterSD(const std::string& aDetectorName,
                      const std::string& aReadoutName,
                      const dd4hep::Segmentation& aSeg);
  /// Destructor
  virtual ~AllEnergyCalorimeterSD();
  /** Initialization.
